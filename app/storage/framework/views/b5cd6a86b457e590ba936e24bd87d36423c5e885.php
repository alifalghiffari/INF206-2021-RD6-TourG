            ...
            <div class="accordion-item">
              ...
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  <strong>Pemberitahuan 1</strong>Halaman
                </div>
                <section class="buttonnotf mb-2">
                  <div class="container">
                <a class="btn btn-secondary-b" href="menu.html" role="button">Tolak</a>
                <a class="btn btn-primary-b" href="menu.html" role="button">Terima</a>
              </section>
              </div>
              </div>
            </div>
            <section class="buttontour mt-3">
            <a class="btn btn-secondary-a" href="<?php echo e(url('/menu')); ?>" role="button">Kembali</a>
          </section>
    </div>
</div>
</section>
...
</html><?php /**PATH C:\xampp\htdocs\app_laravel\app_laravel\resources\views/Pemberitahuan.blade.php ENDPATH**/ ?>