            ...
            <div class="accordion-item">
              ...
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                ...
                <section class="buttonnotf mb-2">
                  <div class="container">
                <a class="btn btn-secondary-b" href="{{ url('/batal') }}" role="button">Tolak</a>
                <a class="btn btn-primary-b" href="{{ url('/aktivitas') }}" role="button">Terima</a>
              </section>
              </div>
              </div>
            </div>
            <section class="buttontour mt-3">
            <a class="btn btn-secondary-a" href="{{ url('/') }}" role="button">Kembali</a>
          </section>
    </div>
</div>
</section>
